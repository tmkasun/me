...
![Source structure](/images/posts/apim_320_customization/WSO2-API-Manager-3-x-portals-structure.png)
...
![](/images/posts/apim_320_customization/goto.gif)
...
![](/images/posts/apim_320_customization/blog_customization.png)
...
![](/images/posts/apim_320_customization/WSO2-API-Managerbuild_pipe.png)
...
![](/images/posts/apim_320_customization/WSO2-API-build.png)
...
![](/images/posts/apim_320_customization/Publisher-WSO2-APIM-create-api.png)
...
-   Another method is to use network trace, If the Interactions with your target component triggers any network calls , You can use the stack trace in the Browser's network inspector to locate the source component
    ![](/images/posts/apim_320_customization/nt_trace.png)
-   Or the other option is to set **Event Listener Breakpoints** from browser Source panel(in Chrome) or Debugger panel (in FireFox). You most probably need to black-box some irrelevant handlers multiple times, But you will get to the original source component at some point, So have some patient when following this method
    ![](/images/posts/apim_320_customization/source_debug.png)
...
![](/images/posts/apim_320_customization/blog_customization-Page-2.png)
