...
<?php if ( have_posts() ) : ?>
	...
	<?php 
	/* IF WE HAVE A FEATURED IMAGE THAT IS FULL-WIDTH, THEN USE IT */
		...
		<header class="content-header-image">
			<div class="<?php echo $image_class; ?>" style="background-image: url('<?php echo $image_url; ?>')">
				...
				if ( is_front_page() ) {
					...
					echo '<a style="color: #16A0D4" href="#primary" class="scroll-down smoothscroll"><span class="glyphicon glyphicon-chevron-down"></span></a>';
				} ?>
